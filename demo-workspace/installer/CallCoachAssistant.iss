...
Name: "{group}\Call Coach 新竹主機代理"; Filename: "{app}\CallCoachAssistant.exe"; Parameters: "--host-agent"; Comment: "公司可遠端睡眠；Host Token 在視窗內（與 start_hsinchu_host_agent.cmd 相同）"
